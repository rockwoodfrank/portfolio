    ...
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 500">
                ...
                {/* Laser Platform */}
                <rect x="27" y="439" width="144" height="279" transform="rotate(-90 27 439)" fill="#D9D9D9"/>
                {/* Laser Box */}
                <rect x="172" y="369" width="134" height="70" fill="#535353"/>
                <rect x="158" y="389" width="14" height="32" fill="#535353"/>
                ...
                {/* Unpolarized path */}
                <path fill="none" d="M158 405L85.6758 405V329L352.499 329" stroke="#BF609F" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="39" cy="367" r="6" fill="#D9D9D9"/>
